...
class Blogloggedout
{
    ...
    protected $table = 'commentrepliesnotloggedin';
    ...
    public function addblogcommentnotloggedinreply($data,$commentid, $files, $userID, $postid)
    {
        if ($this->validate($data)) {
            ...
            if (!empty($files["usercommentimage"]["name"])) {
                $folder = "public/commentuploads/repliesnotlogged/";
