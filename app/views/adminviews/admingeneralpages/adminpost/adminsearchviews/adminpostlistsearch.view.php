			...
			<div class="row pb-4">
				<div class="col-12">
					...
					<div class="d-sm-flex justify-content-sm-between align-items-center">
						<h1 class="mb-2 mb-sm-0 h2 ml-3">Post search for<span
								class="badge bg-primary bg-opacity-10 text-primary "><?=!empty($_GET["findblog"]) ? $_GET["findblog"] : 'input search term'?></span>
						</h1>
