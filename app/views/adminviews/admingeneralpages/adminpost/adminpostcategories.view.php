				...
				<div class="card border h-100">
					...
					<div class="card-body p-3">
						...
						<div class="d-flex justify-content-between">
							...
							<ul class="avatar-group mb-0">
								<li class="avatar avatar-xs">
									<img class="avatar-img rounded-circle" src="assets/images/avatar/04.html" alt="avatar">
								</li>
								<li class="avatar avatar-xs">
									<img class="avatar-img rounded-circle" src="assets/images/avatar/05.html" alt="avatar">
								</li>
								<li class="avatar avatar-xs">
									<img class="avatar-img rounded-circle" src="assets/images/avatar/06.html" alt="avatar">
								</li>
								<li class="avatar avatar-xs">
									<div class="avatar-img rounded-circle bg-primary"><i class="fas fa-plus text-white position-absolute top-50 start-50 translate-middle"></i></div>
								</li>
				...
				<div class="card border h-100">
					...
					<div class="card-body p-3">
						...
						<div class="d-flex justify-content-between">
							...
							<ul class="avatar-group mb-0">
								<li class="avatar avatar-xs">
									<img class="avatar-img rounded-circle" src="assets/images/avatar/07.html" alt="avatar">
								</li>
								<li class="avatar avatar-xs">
									<img class="avatar-img rounded-circle" src="assets/images/avatar/08.html" alt="avatar">
								</li>
								<li class="avatar avatar-xs">
									<img class="avatar-img rounded-circle" src="assets/images/avatar/09.html" alt="avatar">
								</li>
								<li class="avatar avatar-xs">
									<div class="avatar-img rounded-circle bg-primary"><i class="fas fa-plus text-white position-absolute top-50 start-50 translate-middle"></i></div>
								</li>
