				...
				<div class="col-12">
					...
					<div class="d-sm-flex justify-content-sm-between align-items-center">
						<h1 class="mb-2 mb-sm-0 h2">Categories <span
								class="badge bg-primary bg-opacity-10 text-primary"><?=$countcategorisnumber?></span>
						</h1>
    ...
    $buttonDisplayed = false; // Flag to track button display
        ...
        $ses = new Adminsession();
				    ...
				    if ($ses->isLoggedIn()) {
				        ...
				        $totalcategory = $getcategories->geteventCategoriesNumber($categoryName);
				        ...
				        ?>
								<div>
									...
									<h6 class="mb-0 fw-light">Total Events</h6>
								</div>
								...
								<h6 class="mb-0 fw-light text-primary">By:
									<?= esc($categorycreator->firstname . " " . $categorycreator->lastname) ?>
								</h6>
								<?php endif; ?>
								<?php endforeach; ?>
								<?php endif; ?>
