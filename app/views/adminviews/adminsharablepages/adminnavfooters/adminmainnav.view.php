		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<ul class="navbar-nav navbar-nav-scroll mx-auto">
					...
					<!-- Nav item 1 Demos -->
					<li class="nav-item"><a class="nav-link" href="<?=ROOTADMIN?>Admindashboard"><i class="bi bi-house-door me-1"></i>Dashboard</a></li>
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="pagesMenu">
							...
							<li class="dropdown-divider"></li>
							<li> <a class="dropdown-item" href="https://support.primesoftwares.tech/" target="_blank"> <i class="text-warning fa-fw bi bi-life-preserver me-2"></i>Support</a></li>
										...
										<a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
											<div class="me-3">
												<div class="avatar avatar-sm">
													<img class="avatar-img rounded-circle" src="<?=ROOTADMIN?><?=ROOTADMIN?>assets/adminassets/admin<?=ROOTADMIN?>assets/adminassets/images/avatar/08.jpg" alt="avatar">
												</div>
											</div>
											<div>
                        <h6 class="mb-1">12 new members joined</h6>
									...
									<li>
										<a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
											<div class="me-3">
												<div class="avatar avatar-sm">
													<img class="avatar-img rounded-circle" src="<?=ROOTADMIN?>assets/adminassets/images/avatar/02.jpg" alt="avatar">
												</div>
											</div>
											<div>
									...
									<li>
										<a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
											<div class="me-3">
												<div class="avatar avatar-sm">
													<img class="avatar-img rounded-circle" src="<?=ROOTADMIN?><?=ROOTADMIN?>assets/adminassets/admin<?=ROOTADMIN?>assets/adminassets/images/avatar/05.jpg" alt="avatar">
												</div>
											</div>
											<div>
					...
					<ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
						...
						<li class="px-3">
							<div class="d-flex align-items-center">
								...
								<div>
									<a class="h6 mt-2 mt-sm-0" href="<?=ROOTADMIN?>Adminsignup">Add Name</a>
									<p class="small m-0" ><a class="h6 mt-2 mt-sm-0" href="<?=ROOTADMIN?>Adminsignup">Add Email</a></p>
								</div>
							</div>
							<hr>
						</li>
						...
						<li><a class="dropdown-item" href="<?=ROOTADMIN?>Adminsignup"><i class="bi bi-power fa-fw me-2"></i>Sign up</a></li>
						<li><a class="dropdown-item" href="<?=ROOTADMIN?>Adminsignin"><i class="bi bi-power fa-fw me-2"></i>Sign in</a></li>
