<nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top ">
  <div class="container-fluid ">
    <a class="navbar-brand myclasslogomarginright" href="<?=ROOTADMIN?>Adminhome"><?php echo esc(APP_NAMEADMIN);?></a>
    <!--  -->
  ...
  <ul class="dropdown-menu">
    <li><a class="dropdown-item" href="<?=ROOTADMIN?>Signup">adminsignup</a></li>
    <li><a class="dropdown-item" href="<?=ROOTADMIN?>Login">adminlogin</a></li>
  </ul>
</li>
    ...
    <div class="offcanvas-header ">
        <h5 class="offcanvas-title" id="offcanvasNavbarLabel"><?php echo esc(APP_NAMEADMIN);?></h5>
      ...
      <div class="offcanvas-body">
        ...
        <li class="nav-item  myclass  ">
          <a class="nav-link active" aria-current="page"  href="<?=ROOTADMIN?>Adminhome">Home</a>
        </li>
        <li class="nav-item  myclass  ">
          <a class="nav-link active" aria-current="page"  href="<?=ROOTADMIN?>Admindashboard">Dashbord</a>
        </li>
      
        <li class="nav-item myclass">
          <a class="nav-link"  href="<?=ROOTADMIN?>Adminevents">Events</a>
        </li>
        <li class="nav-item myclass">
          <a class="nav-link" href="<?=ROOTADMIN?>Adminmedia">Media</a>
        </li>
        <li class="nav-item myclass">
          <a class="nav-link" href="<?=ROOTADMIN?>Adminblog">Blog</a>
        </li>
    ...
    <!--  -->
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="<?=ROOTADMIN?>Adminsignup">Signup</a></li>
          <li><a class="dropdown-item" href="<?=ROOTADMIN?>Adminlogin">Login</a></li>
        </ul>
        </li>
