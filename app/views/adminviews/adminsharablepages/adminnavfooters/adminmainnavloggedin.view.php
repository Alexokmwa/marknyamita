											...
											<div class="me-3">
												<div class="avatar avatar-sm">
													<img class="avatar-img rounded-circle"
														src="<?=ROOTADMIN?><?=ROOTADMIN?>assets/adminassets/admin<?=ROOTADMIN?>assets/adminassets/images/avatar/08.jpg"
														alt="avatar">
												</div>
											</div>
											<div>
									...
									<li>
										<a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
											<div class="me-3">
												<div class="avatar avatar-sm">
													<img class="avatar-img rounded-circle"
														src="<?=ROOTADMIN?>assets/adminassets/images/avatar/02.jpg"
														alt="avatar">
												</div>
											</div>
											<div>
									...
									<li>
										<a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
											<div class="me-3">
												<div class="avatar avatar-sm">
													<img class="avatar-img rounded-circle"
														src="<?=ROOTADMIN?><?=ROOTADMIN?>assets/adminassets/admin<?=ROOTADMIN?>assets/adminassets/images/avatar/05.jpg"
														alt="avatar">
												</div>
											</div>
											<div>
									...
									<li>
										<a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
											<div class="me-3">
												<div class="avatar avatar-sm">
													<img class="avatar-img rounded-circle"
														src="<?=ROOTADMIN?>assets/adminassets/images/avatar/03.jpg"
														alt="avatar">
												</div>
											</div>
											<div>
