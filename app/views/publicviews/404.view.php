...
<!-- <h1 class="myclassmargintop">view file page not found</h1> -->

<div class="overflow-hidden myclassmargintop">
	<div class="container">
		<div class="row">
      <div class="col-md-9 text-center mx-auto my-0 my-md-5 py-0 py-lg-5 position-relative z-index-9">
        ...
        <a href="<?=ROOT?>Home" class="btn btn-danger-soft mt-3"><i class="bi bi-arrow-left"></i>Back to home page</a>
      </div>
    </div>
	</div>
</div>
