...
foreach ($data['eventpost'] as $eventpost): 
    if ($eventpost->status === "live" && $eventpost->eventschedule === 'upcomming'):
        if ($slideCount >= 3) break; // Stop the loop if the slide count reaches 2
                ...
                <div class="row g-0">
                    <div class="col-xl-6 col-md-6">
                        <div class="card-body h-100 d-flex align-items-start flex-column p-lg-7">
                            <div class="mb-3">
                                <small class="text-uppercase fw-semibold ls-md"><?=$eventpost->eventtype?><i class="text-primary ms-4">upcomming event</i></small>
            ...
            <div class="card shadow-sm overflow-hidden">
                <div class="row g-0">
                    <div class="col-xl-6 col-md-6">
                        <div class="card-body h-100 d-flex align-items-start flex-column p-lg-7">
                            <div class="mb-3">
                                <small class="text-uppercase fw-semibold ls-md"><?=$eventpost->eventtype?><i class="text-primary ms-4">Featured event</i></small>
                                <h2 class="mb-0 mt-3"><a href="#" class="text-reset"><?=$eventpost->eventname?></a></h2>
                            </div>
                            <div class="mb-5">
                                <small class="me-2"><?=get_date($eventpost->eventdate)?></small>
...
if (!$currentEventFound): 
    ?>
    <p class="text-center text-danger">No current event</p>
<?php endif; ?>
    ...
    <?php endif; ?>
<?php else: ?>
    <p class="text-danger text-center">No current events posts found.</p>
<?php endif; ?>
