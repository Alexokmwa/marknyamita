...
<nav class="myclassallignsecondnav navbar navbar-expand-xl navbar-light navbar-sticky header-static pt-2">
	<div class="container-fluid">
		...
		<ul class="navbar-nav  navbar-nav-scroll mx-auto d-flex flex-row flex-nowrap">
			<!-- Nav Search -->
			<li class="nav-item me-3"><a class="nav-link" href="<?=ROOT?>Blog"></i>Videos</a></li>
			<li class="nav-item  me-3"><a class="nav-link" href="<?=ROOT?>Blog#trending"></i>Podcast</a></li>
			<li class="nav-item me-3"><a class="nav-link" href="<?=ROOT?>Blog#recent"></i>pdfs</a></li>
