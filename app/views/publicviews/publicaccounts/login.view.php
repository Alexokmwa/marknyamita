...
<div>
	<div class="mysmbottomspace">
		...
		<div class="card shadow container-fluid border col-lg-5 col-md-6 pt-2  myclassmargintop">
			...
			<form method="post">
				...
				<div class="mb-3">
								 ...
								 <input value="<?=old_value('email')?>" name="email" type="email" class="form-control" id="signinEmailInput" required />
			...
			<div class="p-3">
				<div>
					<p>Create account <a href="<?=ROOT?>Signup">Signup
							Here</a></p>
				</div>
			</div>
		</div>
			<!-- <form method="post">
				...
				<br>
				<input value="<?=old_value('password')?>"
					name="password" placeHolder="Password"><br>
				<div><?=$user->getError('password')?>
				</div>
				<br>
				<button>Login</button>
			</form> -->
