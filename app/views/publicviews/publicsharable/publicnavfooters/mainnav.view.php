<!-- main nav in all pages -->
<nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top ">
  <div class="container-fluid ">
    <div class="myclasslogomarginright  d-flex">
      <a class="navbar-brand mylogobariconsfirst" href="<?=ROOT?>home"><?php echo esc(APP_NAME);?></a>
      <div class="d-flex float-right overflow-x: auto;">
        
      <h1 class="d-block d-md-none mylogobariconssecond" style="margin-left: -20px; margin-right: 60px;">
      <svg xmlns="http://www.w3.org/2000/svg" class="d-none " >
        ...
        <button type="button" class="btn  position-relative  d-block d-md-none mylogobariconssecond">
    ...
    <div class=" d-flex ">
      <form class="d-flex mt-3 ms-auto d-block d-md-none mylogobariconssecondform "   role="search">
          <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search">
          <button class="btn btn-outline-success" type="submit">Search</button>
      </form>
      <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="navbarSupportedContent" aria-controls="offcanvasNavbar" aria-label="Toggle navigation" style="margin-top:10px;">
  <span class="navbar-toggler-icon"></span>
    ...
    <div class="offcanvas-header ">
      ...
      <div class="offcanvas-body">
        ...
        <li class="nav-item myclass">
          <a class="nav-link"  href="<?=ROOT?>">About us</a>
        </li>
        <li class="nav-item myclass">
          <a class="nav-link" href="<?=ROOT?>">Events</a>
        </li>
